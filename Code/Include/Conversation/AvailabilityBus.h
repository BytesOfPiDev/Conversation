...
{
	class AvailabilityNotifications
	...
	public:
		...
		virtual bool OnAvailabilityCheck() { return false; }
	};
	...
	{
	public:
		AZ_EBUS_BEHAVIOR_BINDER(BehaviorAvailabilityNotificationBusHandler, "{D6037DA0-68CD-40F3-AB56-C91A6E7F4C3D}", AZ::SystemAllocator,
			OnAvailabilityCheck);
