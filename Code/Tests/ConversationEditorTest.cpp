...
AZ_UNIT_TEST_HOOK(
    new ConversationEditorTest::ConversationEditorTestEnvironment);
...
namespace ConversationEditorTest
{
    ...
    protected:
        void SetUp() override
        {
            m_fileDataCache = AZStd::make_unique<
                AtomToolsFramework::GraphTemplateFileDataCache>(TestToolId);
            m_compiler = AZStd::make_unique<
                ConversationEditor::ConversationGraphCompiler>();
        }
        ...
        AZStd::unique_ptr<AtomToolsFramework::GraphTemplateFileDataCache>
            m_fileDataCache{};
        AZStd::unique_ptr<ConversationEditor::ConversationGraphCompiler>
            m_compiler{};
    };
    ...
    TEST_F(ConversationCompilerTests, Fixture_SanityCheck)
    {
        ...
        EXPECT_EQ(
            m_compiler->GetState(),
            AtomToolsFramework::GraphCompiler::State::Idle);
