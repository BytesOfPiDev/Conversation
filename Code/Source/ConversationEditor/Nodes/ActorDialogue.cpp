        ...
        {
            {
                ...
                RegisterSlot(GraphModel::SlotDefinition::CreateOutputEvent(
                    CommonSlotDisplayNames::EXIT, CommonSlotDisplayNames::EXIT, CommonSlotDescriptions::EXIT, &config));
            }

            RegisterSlot(GraphModel::SlotDefinition::CreateInputEvent(
                CommonSlotNames::ENTER, CommonSlotDisplayNames::ENTER, CommonSlotDescriptions::ENTER));

            auto defaultDialogueData = Conversation::DialogueData(true);
            // DialogueId property
            ...
            RegisterSlot(GraphModel::SlotDefinition::CreateProperty(
                CommonSlotNames::DIALOGUEID, CommonSlotDisplayNames::DIALOGUEID, GetGraphContext()->GetDataType<Conversation::DialogueId>(),
                AZStd::any(dialogueDataPtr->GetId()), CommonSlotDescriptions::DIALOGUEID));

            // DialogueData property
            RegisterSlot(GraphModel::SlotDefinition::CreateProperty(
                CommonSlotNames::DIALOGUEDATA, CommonSlotDisplayNames::DIALOGUEDATA,
                GetGraphContext()->GetDataType<Conversation::DialogueDataPtr>(), AZStd::any(dialogueDataPtr),
                CommonSlotDescriptions::DIALOGUEDATA));
            // DialogueScripts property
            RegisterSlot(GraphModel::SlotDefinition::CreateProperty(
                SlotNames::DIALOGUESCRIPTS, SlotDisplayNames::DIALOGUESCRIPTS, GetGraphContext()->GetDataType<AZStd::set<AZStd::string>>(),
                AZStd::make_any<AZStd::set<AZStd::string>>(), SlotDescriptions::DIALOGUESCRIPTS, nullptr));
            // DialogueId output
            RegisterSlot(GraphModel::SlotDefinition::CreateOutputData(
                CommonSlotNames::OUTPUTDIALOGUEID, CommonSlotDisplayNames::OUTPUTDIALOGUEID,
                GetGraphContext()->GetDataType<Conversation::DialogueId>(), CommonSlotDescriptions::OUTPUTDIALOGUEID));
        }
    } // namespace Nodes
} // namespace ConversationEditor
