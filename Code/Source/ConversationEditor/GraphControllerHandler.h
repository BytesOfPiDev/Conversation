...
namespace ConversationEditor
{
		class GraphControllerHandler
			: private GraphModelIntegration::GraphControllerNotificationBus::MultiHandler
		{
		public:
		...
		private:
			...
			void OnGraphModelNodeUnwrapped(GraphModel::NodePtr /*wrapperNode*/, GraphModel::NodePtr /*node*/) override {}
