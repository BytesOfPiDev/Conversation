...
namespace DialogueEditor
{
	...
	{
	public:
		//AZ_TYPE_INFO(CommandDefinition, "{2C0630DF-0D51-4E16-B89E-B4AC947AEE79}");
	...
	public:
		...
		AvailabilityCheckCard(const Command& leftCommand, const Command& rightCommand, QWidget* parent = nullptr)
			: AzQtComponents::Card(parent)
			, m_left(leftCommand)
